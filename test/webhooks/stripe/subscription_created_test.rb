...
class Pay::StripeWebhooksSubscriptionCreatedTest < ActiveSupport::TestCase
  setup do
  ...
  test "subscription is created" do
    ...
    Pay::Webhooks::Stripe::SubscriptionCreated.new.call(@event)
  ...
  test "does not create a subscription when the user does not exist" do
    result = Pay::Webhooks::Stripe::SubscriptionCreated.new.call(@event)
